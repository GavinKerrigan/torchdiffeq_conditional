...
def conditional_odeint(func, y0, t, z, z_xs, z_idxs, forward_process, *, rtol=1e-7, atol=1e-9, method=None, options=None, event_fn=None):
    """Integrate a system of ordinary differential equations.
    ...
    solver = SOLVERS[method](func=func, y0=y0, rtol=rtol, atol=atol, z=z, z_xs = z_xs, z_idxs=z_idxs, forward_process=forward_process, **options)
